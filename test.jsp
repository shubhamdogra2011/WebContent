...
<body >
<div style="    background-image: url('photo-1429277096327-11ee3b761c93.jpg'); background-repeat: no-repeat;
    background-attachment: fixed; background-size: cover;">

	<br><br>
	<div class="well" style="margin:10%;background: rgba(18, 34, 43, 0.3); border:0;">
		<div class="row">
			<div class="col-lg-6">
